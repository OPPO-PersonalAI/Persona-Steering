...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "persona_steering":
        run_persona_steering(model_args, data_args, training_args, finetuning_args, callbacks)
    elif finetuning_args.stage == "persona_profile_steering":
        run_persona_profile_steering(model_args, data_args, training_args, finetuning_args, callbacks)
    else:
