...
class RLHFArguments:
    ...
    use_dpo: bool = field(
        default=False,
        metadata={"help": "Whether to use DPO training (for PersonaSteering)."},
    )
...
class FinetuningArguments(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "dpo", "kto", "persona_steering", "persona_profile_steering"] = field(
        default="sft",
        metadata={"help": "Which stage will be performed in training."},
    )
    finetuning_type: Literal["lora", "oft", "freeze", "full", "persona_steering"] = field(
        default="lora",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "oft", "freeze", "full", "persona_steering"], "Invalid fine-tuning method."
